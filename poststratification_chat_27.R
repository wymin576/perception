...
data {
  int<lower=0> N;
  array[N] int<lower=1, upper=27> state;
  ...
  array[27] real ratio_urban_rural, per_capita, college, growth_of_gdp;
  array[27] real<lower=0, upper=1> rate_coresid, migration, mot_il,
  fat_farmer, status_yuv;
  
  // area mapping
  array[27] int<lower=1, upper=4> area;
  array[27, 4, 2, 2] int<lower=0> P;
...
fit.bb$save_object("poststratification_norm_chat_27.rds")